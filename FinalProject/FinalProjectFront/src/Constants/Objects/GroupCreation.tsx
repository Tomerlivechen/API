...
const groupValues : INewSocialGroup = {
    ...
    const validationScheme = Yup.object({
        ...
        description : Yup.string().min(2).max(200).required("The group description is required"),
})
...
<button onClick={toggleOpen} className="ml-6 flex items-center p-2 border rounded">
